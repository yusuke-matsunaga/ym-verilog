#ifndef LIBYM_YM_SIMULATOR_SIMEVENTQUEUE_H
#define LIBYM_YM_SIMULATOR_SIMEVENTQUEUE_H

/// @file libym/simulator/SimEventQueue.h
...
#endif // LIBYM_YM_SIMULATOR_SIMEVENTQUEUE_H
