#ifndef LIBYM_YM_SIMULATOR_SIMCALINKQUEUE_H
#define LIBYM_YM_SIMULATOR_SIMCALINKQUEUE_H

/// @file libym/simulator/SimCaLinkQueue.h
...
#endif // LIBYM_YM_SIMULATOR_SIMCALINKQUEUE_H
